...
},{"./components/McmsSelect.vue":3,"./components/MiniForm.vue":4,"_process":6,"vue":1,"vue-i18n":7,"vue-recaptcha":8,"vuelidate":10}],3:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        onChange: function onChange() {
            this.$emit('update', this.field.varName, this._model);
        }
    },
    created: function created() {
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<div class=select-wrapper>{{ field.label[locale] }}<select v-model=_model @change=onChange class=\"select--wd select--wd--sm\"><option v-for=\"option in field.options\" :value=option.value>{{ option.label }}</select></div>"

},{}],4:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("input::-webkit-inner-spin-button,input::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}")
'use strict';
...
var SetupForm = require('../mixins/setupForm.mixin');

var _require = require('../services/submitForm'),
...
exports.default = {
    ...
    methods: {
        ...
        updateModel: function updateModel(key, value) {
        ...
        onSubmit: function onSubmit() {
            ...
            Form.send(this.formData).then(function (response) {
                if (response.success) {
                    _this.success = true;
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<div><div class=\"alert alert-success\" v-if=success>{{ $t('labels.success') }}</div><div class=\"alert alert-danger\" v-if=error>{{ $t('validations.alreadyParticipated') }}</div><div class=\"alert alert-info\" v-if=submitting>{{ $t('labels.submitting') }}</div><form id=miniForm name=miniForm method=post novalidate v-if=\"!success &amp;&amp; !submitting\" v-on:submit.prevent=onSubmit><div class=input-field v-for=\"field in Form.fields\"><input type=email @input=$v.formData[field.varName].$touch() v-if=\"field.type === 'email'\" class=input--full v-bind:name=field.varName v-bind:disabled=field.disabled v-model=formData[field.varName]> <input type=text @input=$v.formData[field.varName].$touch() v-if=\"field.type === 'text'\" class=input--full v-bind:name=field.varName v-model=formData[field.varName]> <input type=number @input=$v.formData[field.varName].$touch() v-if=\"field.type === 'number'\" :min=field.min :max=field.max :step=field.step class=input--full v-bind:name=field.varName v-model=formData[field.varName]><mcms-select :model=formData[field.varName] :field=field @update=updateModel v-if=\"field.type === 'select'\"></mcms-select><textarea @input=$v.formData[field.varName].$touch() v-if=\"field.type === 'textarea'\" class=input--full v-bind:name=field.varName v-model=formData[field.varName]></textarea><span class=input-group__bar></span> <span :for=field.varName class=error v-if=\"$v.formData[field.varName] &amp;&amp; $v.formData[field.varName].$dirty &amp;&amp; !$v.formData[field.varName].required\">{{ $t('validations.required') }}</span> <span :for=field.varName class=error v-if=\"field.type === 'email'\n    &amp;&amp; $v.formData[field.varName].$dirty &amp;&amp; !$v.formData[field.varName].email\" v-html=\"$t('validations.email')\"></span><label v-if=\"field.type !== 'select'\">{{ field.label[locale] }}</label></div><button type=submit id=submit :disabled=\"$v.$invalid || submitting\" class=\"btn btn--wd wave waves-effect\">{{ $t('labels.submit') }}</button></form></div>"

},{"../mixins/setupForm.mixin":5,"../services/submitForm":31,"vueify/lib/insert-css":9}],5:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    created: function created() {
        var Form = typeof window[this.$options.propsData.formSettings] !== 'undefined' ? window[this.$options.propsData.formSettings] : {};
        var fields = {};
        ...
        Form.fields.map(function (field) {
            ...
            if (field.type === 'select') {
                ...
                var defaultValue = selectDefaultValue(field.options, 'default', true);
                fields[field.varName] = defaultValue ? defaultValue.value : '';
            }

            if (typeof field.required !== 'undefined' && field.required) {
                validations.formData[field.varName] = { required: required };
                if (field.type === 'email') {
        ...
        if (Form.inject && typeof Form.inject.defaults !== 'undefined') {
            for (var key in Form.inject.defaults) {
...
},{"vue":1,"vuelidate/lib/validators":18}],6:[function(require,module,exports){
...
},{"./params":11,"./vval":28}],11:[function(require,module,exports){
'use strict';
...
},{"./common":16}],13:[function(require,module,exports){
'use strict';
...
},{"./common":16}],14:[function(require,module,exports){
'use strict';
...
},{"./common":16}],16:[function(require,module,exports){
'use strict';
...
},{"../withParams":29}],17:[function(require,module,exports){
'use strict';
...
},{"./alpha":12,"./alphaNum":13,"./and":14,"./between":15,"./email":17,"./maxLength":19,"./minLength":20,"./numeric":21,"./or":22,"./required":23,"./requiredIf":24,"./requiredUnless":25,"./sameAs":26,"./url":27}],19:[function(require,module,exports){
'use strict';
...
},{"./common":16}],20:[function(require,module,exports){
'use strict';
...
},{"./common":16}],22:[function(require,module,exports){
'use strict';
...
},{"./common":16}],23:[function(require,module,exports){
'use strict';
...
},{"./common":16}],24:[function(require,module,exports){
'use strict';
...
},{"./common":16}],25:[function(require,module,exports){
'use strict';
...
},{"./common":16}],26:[function(require,module,exports){
'use strict';
...
},{"./common":16}],28:[function(require,module,exports){
"use strict";
...
},{"./params":11,"./withParamsBrowser":30}],30:[function(require,module,exports){
(function (global){
'use strict';
...
var SubmitForm = exports.SubmitForm = function () {
    function SubmitForm(form) {
        ...
        setTimeout(function () {
            _this.post = window.$.post;
            _this.get = window.$.get;
            _this.http = window.$.ajax;
            ...
            _this.form = form;
            _this.postTo = typeof form.postTo !== 'undefined' ? form.postTo : '/contactForm';
        }, 1000);
    }
    ...
    _createClass(SubmitForm, [{
        ...
        value: function send(data) {
            var toPost = _vue2.default.util.extend({}, data);
