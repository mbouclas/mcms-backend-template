...
},{"./components/McmsSelect.vue":3,"./components/MiniForm.vue":4,"vue":1,"vue-i18n":8,"vuelidate":9}],3:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        onSubmit: function onSubmit() {
            ...
            Form.post(this.formData).then(function (response) {
                if (response.success) {
                    _this.success = true;
...
},{"../mixins/setupForm.mixin":5,"../services/submitForm":30,"vue":1,"vue-hot-reload-api":7}],5:[function(require,module,exports){
'use strict';
...
var SubmitForm = exports.SubmitForm = function () {
    ...
    _createClass(SubmitForm, [{
        ...
        value: function post(data) {
            ...
            return this.post(this.postTo, toPost).then(function (response) {
