...
},{"./components/McmsSelect.vue":3,"./components/MiniForm.vue":4,"_process":6,"vue":1,"vue-i18n":8,"vuelidate":10}],3:[function(require,module,exports){
'use strict';
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"select-wrapper\">\n    {{ field.label[locale] }}\n    <select v-model=\"_model\" @change=\"onChange\" class=\"select--wd select--wd--sm\">\n        <option v-for=\"option in field.options\" :value=\"option.value\">\n            {{ option.label }}\n                </option>\n    </select>\n</div>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6be5c0da", module.exports)
  } else {
    hotAPI.update("_v-6be5c0da", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":1,"vue-hot-reload-api":7}],4:[function(require,module,exports){
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n    <div class=\"alert alert-success\" v-if=\"success\">{{ $t('labels.success') }}</div>\n    <div class=\"alert alert-danger\" v-if=\"error\">{{ $t('validations.alreadyParticipated') }}</div>\n    <div class=\"alert alert-info\" v-if=\"submitting\">{{ $t('labels.submitting') }}</div>\n\n    <form id=\"miniForm\" name=\"miniForm\" method=\"post\" novalidate=\"novalidate\" v-if=\"!success &amp;&amp; !submitting\" v-on:submit.prevent=\"onSubmit\">\n        <div class=\"input-field\" v-for=\"field in Form.fields\">\n            <div v-if=\"field.type === 'number'\">\n                {{ field }}\n            </div>\n            <input type=\"email\" @input=\"$v.formData[field.varName].$touch()\" v-if=\"field.type === 'email'\" class=\"input--full\" v-bind:name=\"field.varName\" v-bind:disabled=\"field.disabled\" v-model=\"formData[field.varName]\">\n            <input type=\"text\" @input=\"$v.formData[field.varName].$touch()\" v-if=\"field.type === 'text'\" class=\"input--full\" v-bind:name=\"field.varName\" v-model=\"formData[field.varName]\">\n            <input type=\"number\" @input=\"$v.formData[field.varName].$touch()\" v-if=\"field.type === 'number'\" :min=\"field.min\" :max=\"field.max\" :step=\"field.step\" class=\"input--full\" v-bind:name=\"field.varName\" v-model=\"formData[field.varName]\">\n            <mcms-select :model=\"formData[field.varName]\" :field=\"field\" @update=\"updateModel\" v-if=\"field.type === 'select'\"></mcms-select>\n\n            <textarea @input=\"$v.formData[field.varName].$touch()\" v-if=\"field.type === 'textarea'\" class=\"input--full\" v-bind:name=\"field.varName\" v-model=\"formData[field.varName]\"></textarea>\n            <span class=\"input-group__bar\"></span>\n\n            <span :for=\"field.varName\" class=\"error\" v-if=\"$v.formData[field.varName] &amp;&amp; $v.formData[field.varName].$dirty &amp;&amp; !$v.formData[field.varName].required\">\n                {{ $t('validations.required') }}</span>\n            <span :for=\"field.varName\" class=\"error\" v-if=\"field.type === 'email'\n    &amp;&amp; $v.formData[field.varName].$dirty &amp;&amp; !$v.formData[field.varName].email\" v-html=\"$t('validations.email')\"></span>\n\n            <label v-if=\"field.type !== 'select'\">{{ field.label[locale] }}</label>\n        </div>\n        <button type=\"submit\" id=\"submit\" :disabled=\"$v.$invalid || submitting\" class=\"btn btn--wd wave waves-effect\">{{ $t('labels.submit') }}\n        </button>\n\n\n    </form>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-8d004c86", module.exports)
  } else {
    hotAPI.update("_v-8d004c86", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../mixins/setupForm.mixin":5,"../services/submitForm":31,"vue":1,"vue-hot-reload-api":7,"vueify/lib/insert-css":9}],5:[function(require,module,exports){
'use strict';
