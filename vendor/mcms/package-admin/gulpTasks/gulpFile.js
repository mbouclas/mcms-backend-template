...
gulp.task('buildRedactor',[],require('./gulp.task.buildRedactor')(gulp,Config,$));
gulp.task('watch-redactor',['buildRedactor'],require('./gulp.task.watch-redactor')(gulp,Config,$));
...
gulp.task('watchify',[],require('./gulp.task.watchify')(gulp,Config,$));
