		...
		return {
			getTemplate: function()
			{
				...
				+ '<section id="redactor-modal-table-insert">'
                    ...
                    + '<label>Type</label>'
                    + '<select id="redactor-table-class" >' +
					'<option value="">Default</option>' +
					'<option value="table-bordered">Bordered table</option>' +
					'<option value="table-striped">Striped rows</option>' +
					'<option value="table-hover">Hover rows</option>' +
					'<option value="table-condensed">Condensed table</option>' +
					'</select>'
				+ '</section>';
			},
			init: function()
			...
			insert: function()
			{
				...
				var rows = $('#redactor-table-rows').val(),
					...
					type = $('#redactor-table-class').val(),
					$tableBox = $('<div>'),
					tableId = Math.floor(Math.random() * 99999),
					$table = $('<table class="table ' + type +'" id="table' + tableId + '"><tbody></tbody></table>'),
					i, $row, z, $column;
